                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    {appt.description && (
                      <div className="rounded-sm border border-zinc-800 bg-zinc-950/60 p-3">
                        <p className="text-zinc-500 text-xs uppercase tracking-widest mb-1">Motivo de la cita</p>
                        <p className="text-zinc-300 text-sm leading-relaxed">{appt.description}</p>
                      </div>
                    )}
                  </div>
